...
class StandardIndexPageRelatedLink(Orderable, AbstractRelatedLink):
    page = ParentalKey('StandardIndexPage',
                       related_name='related_links', on_delete=models.CASCADE)
...
class BlogEntryPage(Page):
    ...
    api_fields = (
        ...
        APIField('date'),
        APIField('feed_image'),
        APIField('feed_image_thumbnail', serializer=ImageRenditionField(
            'fill-300x300', source='feed_image')),
